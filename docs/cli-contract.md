...
Help must be compact and example-driven:
...
Usage:
  jira probe [flags]
  jira search '<JQL>' [flags]
  jira issue <KEY> [flags]
  jira skill install [flags]
...
Avoid long prose in CLI help. Put detailed docs under `docs/`.
